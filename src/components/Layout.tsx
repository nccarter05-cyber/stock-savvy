...
import { Package, Home, AlertTriangle, Plus, ListPlus, LogOut, Menu, Users, FileUp, Shield, ScanLine, FileText } from 'lucide-react';
...
const Layout = ({ children }: { children: React.ReactNode }) => {
  ...
  const navItems = [
    ...
    { path: '/scan-invoice', icon: ScanLine, label: 'Scan' },
        ...
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
                ...
                <SheetContent side="left" className="w-72 p-0">
                  <div className="flex flex-col h-full">
                    <div className="flex items-center gap-2 p-4 border-b">
                      ...
                      <span className="text-lg font-bold">Simple Inventory</span>
                    </div>
              ...
              <Package className="h-6 w-6 text-primary" />
              <h1 className="text-lg md:text-xl font-bold text-foreground">Simple Inventory</h1>
            </div>
            {user && (
